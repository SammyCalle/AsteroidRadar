...
fun bindAsteroidStatusImage(imageView: ImageView, isHazardous: Boolean) {
    if (isHazardous) {
        imageView.apply {
            ...
            getString(R.string.potentially_hazardous_asteroid_description)
        }
    } else {
        imageView.apply {
            this.setImageResource(R.drawable.ic_status_normal)
            this.contentDescription = context.getString(R.string.not_potentially_hazardous_asteroid_description)
        }
    }
}
